...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  ...
  <?php if($this->session->userdata('akses')=='1'):?>
      ...
      <li><a href="<?php echo base_url().'index.php/page/kwitd'?>">Kwitansi Hapus</a></li>
      <li><a href="<?php echo base_url().'index.php/page/kwitansi'?>">Kwitansi</a></li>
      <li><a href="<?php echo base_url().'index.php/page/lapor'?>">Laporan</a></li>
  <!--Akses Menu Untuk Dosen-->
  <?php elseif($this->session->userdata('akses')=='2'):?>
      <li class="active"><a href="<?php echo base_url().'index.php/page'?>">Dashboard</a></li>
      <li><a href="<?php echo base_url().'index.php/page/data_user'?>">Data User</a></li>
      <li><a href="<?php echo base_url().'index.php/page/kwitd'?>">Kwitansi</a></li>
